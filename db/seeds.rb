...
b1 = Book.create(title: "The New Machiavelli", publication_year: 1911, pages:180, cover_image: "https://pictures.abebooks.com/isbn/9780140005752-uk.jpg")
...
b3 = Book.create(title: "God Created the Integers", publication_year: 2007, pages:197, cover_image: "https://images-na.ssl-images-amazon.com/images/I/71X9nwKsXIL.jpg")
...
r1 = b1.reviews.create(username: "whiner",title: "Beware: Small Print",rating: 3, text: "I'm used to seeing Large Print featured as a plus for people with vision problems. This book needs to be clearly identified as Small Print. I understand and appreciate the technology of producing economical editions of out-of-copyright books, but buyers should be warned that books like this may require the use of a magnifying glass.")
...
r4 = b3.reviews.create(username: "BookGirl1",title: "A gift. Much appreciated. As described. Thanks ...",rating: 5, text: "A gift. Much appreciated. As described. Thanks.")
r5 = b3.reviews.create(username: "I'm a reader",title: "Hundreds of typos in the math. AVOID THIS BOOK!",rating: 1, text: "I'm giving this 1 star because of all the typos. The typos are in the math, making you stumble and feel dumb for not getting it, until you realize there is a typo after mentally trying various corrections to see if one of them makes the answer work out. Oh... there's the typo! I d i o t s!")
...
r10 = b7.reviews.create(username: "Bicycle Walrus", title: "Watch the Movie - Leave the Book Behind", rating: 2, text: "The author inserts bits and pieces of his own prejudice into the book that serves no purpose other than to stroke his own ego. He paints a picture of a cutthroat world in which women are inferior. The author's narrow minded world view did an incredible disservice to the single redeeming factor about this book.")
r11 = b8.reviews.create(username: "LunarEclipse", title: "Amazing Books", rating: 5, text: "I love all of the Harry Potter novels, but this one is by far my favorite! From the very first time I read it as a 7 year old (when the book first came out in 1999) I loved the change of pace from the other books in the series - for once, Lord Voldemort is not the main antagonist, and instead it's Sirius Black - or at least so we think!")
r12 = b8.reviews.create(username: "Andrew J.", title: "Lord of Rings was better!", rating: 1, text: "Harry potter is for kids. I'm an adult and I like Lord of the Rings. Legolas is awesome! He is bae! I think JK Rowling is an imposter of an author and Tolkien is far superior!")
